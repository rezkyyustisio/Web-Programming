...
<?php  
/*
	Nama file 		: 16_03_list-penjualan.php
	NIM 			: 3201816021
	Nama 			: Rezky Yustisio Hadi Pratama
	Deskripsi 		: Menampilkan list penjualan
*/
...
<body>
	...
	<nav>
		...
		<form action="16_01_template.php" method="GET" style="float: right">
			...
			<input type="hidden" name="menu" value="16_04_list-sepeda">
			...
			<?php 
				...
				if(isset($_GET['cari'])){
					...
					$sql = "SELECT penjualan.id, sepeda.merk_sepeda, konsumen.nama_konsumen, konsumen.provinsi, konsumen.alamat, penjualan.qty, penjualan.jumlah_setor_uang, penjualan.status FROM penjualan
						INNER JOIN sepeda ON sepeda.id = penjualan.id_sepeda
						INNER JOIN konsumen ON konsumen.id = penjualan.id_konsumen 
						WHERE konsumen.nama_konsumen LIKE '%$cari%'";
				}
